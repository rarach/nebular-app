export class Account {
    constructor(public readonly address: string, public domain: string){
...
export const KnownAccounts = {
    ...
    "Papaya3" : new Account("GC5LOR3BK6KIOK7GKAUD5EGHQCMFOGHJTC7I3ELB66PTDFXORC2VM5LP", "apay.io"),   //Does only LTC
    "Papaya4" : new Account("GAEGOS7I6TYZSVHPSN76RSPIVL3SELATXZWLFO4DIAFYJF7MPAHFE7H4", "apay.io"),   //Does only BCH
    ...
    "WhiteStandard": new Account("GDSVWEA7XV6M5XNLODVTPCGMAJTNBLZBXOFNQD3BNPNYALEYBNT6CE2V", "thewwallert.com")
};
